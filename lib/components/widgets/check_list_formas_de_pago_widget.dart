...
class CheckListFormasdePago extends StatefulWidget {
  final int num;

  const CheckListFormasdePago({Key key, this.num});

  @override
  CheckListFormasdePagoState createState() {
    return CheckListFormasdePagoState();
  }
}

class CheckListFormasdePagoState extends State<CheckListFormasdePago> {
  String _currText = '';
