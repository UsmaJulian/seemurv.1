...
class RangoPreciosSlider extends StatefulWidget {
  @override
  _RangoPreciosSliderState createState() => _RangoPreciosSliderState();
}

class _RangoPreciosSliderState extends State<RangoPreciosSlider> {
...
class RangeSliderData {
  ...
  Widget build(BuildContext context, frs.RangeSliderCallback callback) {
    print("rangodeprecio....");
    print(lowerValueText);
    print(upperValueText);
    return Container(
