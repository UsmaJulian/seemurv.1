          ...
          child: new Container(
            ...
            child: new Column(
              children: <Widget>[
                Padding(
                  padding:
                      const EdgeInsets.only(top: 65.0, left: 0, right: 47.5),
                  child: new Text(
                    '¿En que ciudad estás?',
                    style: new TextStyle(
                      color: Colors.black,
                ...
                Padding(
                  padding:
                      new EdgeInsets.only(top: 8.0, left: 30.0, right: 24.0),
                  child: new Text(
                    ...
                    children: <Widget>[
                      Padding(
                        padding: const EdgeInsets.only(
                            top: 11.5, bottom: 11.5, left: 30.0, right: 89.0),
                        child: new Text(
                          'Manizales',
                          style: new TextStyle(
                            color: Colors.black,
                      ...
                      Padding(
                        padding: const EdgeInsets.only(
                            top: 0, bottom: 0, left: 110.0, right: 0),
                        child: new Radio(
                          value: 1,
                ...
                Container(
                  ...
                  child: new Row(
                    children: <Widget>[
                      Padding(
                        padding: const EdgeInsets.only(
                            top: 11.5, bottom: 11.5, left: 30.0, right: 130.0),
                        child: new Text(
                          'Pereira',
                          style: new TextStyle(
                            color: Colors.black,
                      ...
                      Padding(
                        padding: const EdgeInsets.only(
                            top: 0, bottom: 0, left: 93.0, right: 0),
                        child: new Radio(
                          value: null,
                          groupValue: _radioValue1,
                          onChanged: (int e) => _handleRadioValueChange1(e),
                ...
                Container(
                  ...
                  child: new Row(
                    children: <Widget>[
                      Padding(
                        padding: const EdgeInsets.only(
                            top: 11.5, bottom: 11.5, left: 30.0, right: 199),
                        child: new Text(
                          'Bogotá',
                          style: new TextStyle(
                            color: Colors.black,
                      ...
                      Padding(
                        padding: const EdgeInsets.only(
                            top: 0, bottom: 0, left: 25.0, right: 0),
                        child: new Radio(
                          value: null,
                          groupValue: _radioValue1,
                          onChanged: (int e) => _handleRadioValueChange1(e),
                          activeColor: Color.fromRGBO(245, 175, 0, 99.5),
                        ),
                      ),
                    ],
                  ),
